...
\begin{enumerate}
	...
	\textit{Euclid} cutouts located near bright Milky Way stars that suffer from scattered light or internal optical reflections (\textit{ghosts}), introducing brightness ramps or chromatic contamination that biases automated non-parametric morphological estimates.
\end{enumerate}
